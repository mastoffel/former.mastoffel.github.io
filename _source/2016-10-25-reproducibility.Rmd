...
to comment and to critisize. Much more so then just writing a paragraph in the Methods section.
- Clean, commented code allows to build on it. When you come back to your project years later, 
