...
This looks a bit more like a proper plot. Now we are making it fancy. Often you want to highlight different
groups within a scatterplot. The groups are specified in the factor `species` in the iris data.frame. `species` is a variable, which is why we need to specify it as an aesthetic again.
